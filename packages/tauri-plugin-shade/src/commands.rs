...
pub async fn start_shade_process(state: State<'_, Arc<Mutex<ShadeProcess>>>) -> Result<(), String> {
...
#[tauri::command]
pub async fn get_image(file_path: String) -> Result<Vec<u8>, String> {
  use std::fs;
