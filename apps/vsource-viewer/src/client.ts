...
import Config from "./viewport/Config";
import DefaultMaterial from "./viewport/materials/DefaultMaterial";
import { Texture } from "./viewport/materials/Texture";
import { Geometry } from "./viewport/scene/Geometry";
import { Scene } from "./viewport/scene/Scene";
import { Task } from "./viewport/Scheduler";

import BSPFile from "vsource-decompiler/files/source/BSPFile.mjs";
import GLTFFile from "vsource-decompiler/files/util/GLTFFile.mjs";
import VPKFile from "vsource-decompiler/files/valve/VPKFile.mjs";
...
import "./components/viewport/Viewport.ts";
